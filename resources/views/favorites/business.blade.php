...
@section('dashboard-content')
    <div class="dashboard-table-view">
        <div class="dashboard-btn-group-top dashboard-btn-group">
            <h2>@lang('general.some_favorite', ['some' => trans('general.businesses')])</h2>
        </div>
            ...
            @foreach($favorites as $link)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn favorite-add btn--orange" data-url="{{ route('favorites.business.store', $member->id) }}" style="display: none;">
                            Favorite
                        </button>
                        <button class="btn favorite-delete btn--orange" data-url="{{ route('favorites.business.delete', $member->id) }}">
                            UnFavorite
                        </button>
                    </td>
                </tr>
