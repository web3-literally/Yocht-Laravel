...
<div id="reminders-widget">
    <div class="pull-left reminders-calendar">
        <h4>Reminders</h4>
        <div id="reminders-calendar" class="calendar" data-source="{{ route('dashboard.data.reminder', ['boat_id' => $boat_id]) }}"></div>
    </div>
        ...
        $(function () {
            ...
            var loadEvents = function(date) {
                ...
                if (!block.is(':loading')) {
                    ...
                    $.ajax({
                        url: '{{ route('dashboard.data.events-by-date', ['boat_id' => $boat_id]) }}',
                        data: {
                            date: date
                        }
