...
@section('page_class')
    signup-owner-marine-contractor-account signup signup-marine @parent
@stop
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
                ...
                <div class="white-content-block form-style">
                    {!! Form::open(['route' => 'signup.owner-marine-contractor-account-store', 'method' => 'POST', 'class' => 'mt-3 mb-3']) !!}
