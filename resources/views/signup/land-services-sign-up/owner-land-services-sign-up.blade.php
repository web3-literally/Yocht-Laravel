...
@section('page_class')
    signup-owner-land-services-account signup signup-land-services @parent
@stop

@section('top')
    <div class="top-banner">
        <h1 class="banner-title">@lang('general.land_services')</h1>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
                ...
                <div class="white-content-block form-style">
                    {!! Form::open(['route' => 'signup.owner-land-services-account-store', 'method' => 'POST', 'class' => 'mt-3 mb-3']) !!}
