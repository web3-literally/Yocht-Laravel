...
<div class="business-field data-field">
    <div class="business-template template" style="display:none">
        @component('signup.land-services-sign-up.business.field-row', ['serviceGroups' => $serviceGroups, 'countries' => $countries])
        @endcomponent
    </div>
...
@section('footer_scripts')
    ...
    <script>
        ...
        $(function () {
            $('.business-field .business-data-rows select.data-company-country').select2(select2FormatFlagParams);
        });
        ...
        $(function () {
            ...
            $('.business-field.data-field').each(function (i, el) {
                ...
                field.on('business-field-added', function (el, row) {
                    ...
                    row.find('select.data-company-country').select2(select2FormatFlagParams);
                });
