...
@section('page_class')
    signup-business-account signup signup-marinas-shipyards @parent
@stop
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
                ...
                <div class="white-content-block form-style">
                    {!! Form::open(['route' => ['signup.owner-marinas-shipyards-account.business-info-store', 'id' => $id], 'method' => 'POST', 'files' => true, 'class' => 'mt-3 mb-3']) !!}
                    <div class="container-fluid">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                @include('signup.marinas-shipyards-sign-up.business.field')
                            </div>
                        </div>
                        <div class="row mt-4">
