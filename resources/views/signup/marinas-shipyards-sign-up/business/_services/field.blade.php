    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-8 panel">
                ...
                <p class="alert alert-info">You can select multiple categories from the list below to best fit you for job opportunities.</p>
                <div class="services-categories tree-view"></div>
            </div>
            <div class="col-sm-4 panel">
                <p class="alert alert-info">Select your select categories and further select the specialities and services to improve your job listings.</p>
