...
<link href="{{ asset('assets/vendors/noty/css/noty.css') }}" rel="stylesheet" />
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/noty/js/noty.js') }}" ></script>
<script src="{{ asset('assets/js/pages/jquery.noty.packaged.min.js') }}" ></script>
