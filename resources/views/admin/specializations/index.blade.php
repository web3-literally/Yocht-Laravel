...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Specializations List</li>
        </ol>
    </section>
                ...
                <div class="card panel-primary ">
                    <div class="card-heading clearfix">
                        ...
                        <div class="float-right">
                            <a href="{{ route('admin.specializations.create') }}" class="btn btn-sm btn-default"><span class="fa fa-plus-circle"></span> @lang('button.create')
                            </a>
                        </div>
                    </div>
