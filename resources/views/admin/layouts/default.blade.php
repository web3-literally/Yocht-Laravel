...
<head>
    ...
    <!--page level css-->
    @yield('header_styles')
    <link href="{{ asset('assets/vendors/jquery-easy-loading/jquery.loading.min.css') }}" rel="stylesheet" type="text/css"/>
            ...
            <ul class="nav navbar-nav  list-inline">
                ...
                <li class=" nav-item dropdown user user-menu">
                    <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="{{ Sentinel::getUser()->getProfileThumb('35x35') }}" alt="img" height="35px" width="35px" class="rounded-circle img-fluid float-left"/>
                        <div class="riot">
                            <div>
...
<script src="{{ asset('assets/vendors/jquery-easy-loading/jquery.loading.min.js') }}"></script>
<!-- end of global js -->
<!-- begin page level js -->
