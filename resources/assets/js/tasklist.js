    ...
    $('.add_button').bind('click',function(e){
        ...
        $.ajax({
            ...
            success: function (id) {
                ...
                $(".list_of_items").prepend("<div class='todolist_list showactions list1' id='" + id + "'>  " + "<div class='col-md-8 col-sm-8 col-8 nopadmar custom_textbox1'> <div class='todoitemcheck'>" + checkBox + "</div>" + "<div class='todotext todoitemjs'>" + $("#task_description").val() + " </div> <div class='date'> <span class='label label-default end_date'>" + $("#task_deadline").val() + "</span></div></div>" + twoButtons);
