...
/**
 * Class SignUpMarinasShipyardsBusinessAccountRequest
 * @package App\Http\Requests\SignUp
 */
class SignUpMarinasShipyardsBusinessAccountRequest extends FormRequest
{
    /**
    ...
    public function attributes()
    {
        return [
            ...
            'business.*.vhf_channel' => 'vhf channel',
            'business.*.hours_of_operation' => 'hours of operation',
            'business.*.number_of_ships' => 'number of slips',
            'business.*.map_file' => 'map file',
            'business.*.min_depth' => 'min depth',
            'business.*.max_depth' => 'max depth',
    ...
    public function rules()
    {
        ...
        return [
            ...
            'business.*.vhf_channel' => 'required|numeric|min:1',
            ...
            // Dock info
            'business.*.number_of_ships' => 'nullable|numeric|min:1',
            'business.*.map_file' => 'nullable|mimes:jpg,jpeg,png,gif|max:10000|dimensions:min_width=1024,min_height=768',
            'business.*.min_depth' => 'nullable|numeric|min:1',
            'business.*.max_depth' => 'nullable|numeric|min:1',
