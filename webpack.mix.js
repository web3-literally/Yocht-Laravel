...
const paths = {
    ...
    'autogrow':vendors + 'jQuery-autogrow/',
    ...
    'grideditor': vendors + '@frontwise/grid-editor/dist/',
...
mix.copy(resourcesAssets + 'ckeditor/',  destVendors + 'ckeditor/js/plugins');

// grid editor
mix.copy(paths.grideditor + 'grideditor.css',  destVendors + 'grideditor/css');
mix.copy(paths.grideditor + 'grideditor-font-awesome.css',  destVendors + 'grideditor/css');
mix.copy(paths.grideditor + 'jquery.grideditor.min.js',  destVendors + 'grideditor/js');
mix.copy(paths.grideditor + 'jquery.grideditor.min.js.map',  destVendors + 'grideditor/js');
...
// classifieds
mix.copy( srcCss + 'pages/classifieds.css', destCss + 'pages');
...
mix.copy( srcCss + 'pages/page.css', destCss + 'pages');
mix.copy( srcJs + 'pages/add_newpage.js', destJs + 'pages');
//
// inbox page
...
// jquery-easy-loading
mix.copy(vendors + 'jquery-easy-loading/dist/jquery.loading.min.css', destVendors + 'jquery-easy-loading/jquery.loading.min.css');
mix.copy(vendors + 'jquery-easy-loading/dist/jquery.loading.min.js', destVendors + 'jquery-easy-loading/jquery.loading.min.js');

mix.sass(resourcesAssets + 'sass/bootstrap.scss',destCss + 'bootstrap.css');

mix.copy(srcCss + 'sortable.css',destCss + 'sortable.css');
...
mix.js('resources/assets/js/vue.js', 'public/assets/js');