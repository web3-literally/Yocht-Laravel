...
return [
    ...
    */
    ...
    'aliases' => [
         ...
         * Helpers
         */
        'PermissionsHelper' => \App\Helpers\Permissions::class,
        'PlanHelper' => \App\Helpers\Plan::class,
        'HtmlTruncator' => \HtmlTruncator\Truncator::class,
        'SEO' => Artesaos\SEOTools\Facades\SEOTools::class,
        'WorldWeatherOnline' => \App\Facades\WorldWeatherOnline::class
    ],

    'default_image_format' => 'png',

    'placeholder_url' => 'https://dummyimage.com/{size}/F5F5F5/000000.png&text=No%20Image',

    'allowable_tags' => '<hr><strong><em><u><s><sub><sup><ol><ul><li><p><div><blockquote>',
];
