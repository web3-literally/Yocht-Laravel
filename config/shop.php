...
return [
    ...
    */
    ...
    |
    */
    'transaction' => 'App\Models\Shop\Transaction',
    ...
    */
    ...
    |
    */
    'order_status_purchase' => ['in_process', 'completed'],
    ...
    */
    'gateways' => [
        ...
        'paypalExpressExtended'     =>  App\Gateways\GatewayPayPalExpressExtended::class
    ],
    ...
    */
    ...
    |
    */
    'callback_redirect_route' => 'store.checkout.order',
